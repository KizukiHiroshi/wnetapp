...
class CreateGetorderunitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('getorder_units', function (Blueprint $table){
            $table->id()->comment('id');
            $table->foreignId('businessunit_id')->comment('受注事業所')->references('id')->on('businessunits');
        ...
        DB::statement("alter table wnetdb_test.getorder_units comment '受注事業所';");
    }
    ...
    {
        Schema::dropIfExists('getorder_units');
    }
}
