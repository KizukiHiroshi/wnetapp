...
class CreateRyutustockshellsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ryutu_stockshells', function (Blueprint $table){
            $table->id()->comment('id');
        ...
        DB::statement("alter table wnetdb_test.ryutu_stockshells comment '流通在庫棚';");
    }
    ...
    {
        Schema::dropIfExists('ryutu_stockshells');
    }
}
