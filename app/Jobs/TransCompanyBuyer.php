...
class TransCompanyBuyer implements ShouldQueue
{
    ...
    private function updateNewTable($untreatedrows, $newtablename) {
        foreach ($untreatedrows as $untreatedrow) {
            ...
            // duedate_opt
            $foreginkey = 'option_choices?variablename_system=duedate_opt&&valuename_system=31';
            $duedate_opt_id = $findvalueservice->findValue($foreginkey, 'id');
            ...
            // getorderpriority
            // getordermethod_opt
            $foreginkey = 'option_choices?variablename_system=getordermethod_opt&&no=2';
            $getordermethod_opt_id = $findvalueservice->findValue($foreginkey, 'id');
